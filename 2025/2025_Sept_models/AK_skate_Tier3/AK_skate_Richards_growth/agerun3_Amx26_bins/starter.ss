...
#C starter for model 14.2 Arun3 with fixed growth parameters based on a max age of 26 and changed age bins
...
-2 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2028
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1699851281
