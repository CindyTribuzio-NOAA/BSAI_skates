...
1950.1   #_last_early_yr_nobias_adj_in_MPD 
1970.6   #_first_yr_fullbias_adj_in_MPD 
2011.3   #_last_yr_fullbias_adj_in_MPD 
2028.0   #_first_recent_yr_nobias_adj_in_MPD 
0  #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models)  (1.0 to mimic pre-2009 models) (typical ~0.8; -3 sets all years to 0.0; -2 sets all non-forecast yrs w/ estimated recdevs to 1.0; -1 sets biasadj=1.0 for all yrs w/ recdevs)
...
# 1   LGL LenSelex
           7.6         126.2       92.9554           111          0.05             0          2          0          0          0          0        0.5          0          0  #  Size_DblN_peak_LGL(1)
            ...
            -5             9      0.330093           4.7          0.05             0          3          0          0          0          0        0.5          0          0  #  Size_DblN_descend_se_LGL(1)
...
# 2   TWL LenSelex
           7.6         126.2       73.9541            49          0.05             0          2          0          0          0          0        0.5          0          0  #  Size_DblN_peak_TWL(2)
            ...
            -5             9      0.303471           4.4          0.05             0          3          0          0          0          0        0.5          0          0  #  Size_DblN_descend_se_TWL(2)
...
# 3   SURV LenSelex
           ...
           100           500         285.9          -0.5          0.05             0         -3          0          0          0          0        0.5          0          0  #  Size_Logistic_width_SURV(3)
