...
1968.1   #_first_yr_fullbias_adj_in_MPD 
2018.0   #_last_yr_fullbias_adj_in_MPD 
2030.4   #_first_recent_yr_nobias_adj_in_MPD 
0.3156  #_max_bias_adj_in_MPD(1.0 to mimic pre-2009 models)(typical ~0.8; -3 sets all years to 0.0; -2 sets all non-forecast yrs w/ estimated recdevs to 1.0; -1 sets biasadj=1.0 for all yrs w/ recdevs)
