...
#C CTL for model 14.2 Arun2 with fixed growth parameters based on a max age of 2
...
# Sex: 1  BioPattern: 1  Growth
 -10 30 23.9531567 20 99 0 -3 0 0 0 0 0 0 0 # L_at_Amin_Fem_GP_1
 ...
 0 1 0.07910728 1  0.8 0 -3 0 0 0 0 0 0 0 # CV_young_Fem_GP_1
 0 1 0.01359821 1 0.8 0 -3 0 0 0 0 0 0 0 # CV_old_Fem_GP_1
...
#_Cond -1 #_forecast_recruitment phase (incl. late recr) (0 value resets to maxphase+1)
#_Cond 1 #_lambda for Fcast_recr_like occurring before endyr+1
#_Cond 1943.3 #_last_yr_nobias_adj_in_MPD; begin of ramp
#_Cond 1965.8 #_first_yr_fullbias_adj_in_MPD; begin of plateau
#_Cond 2018 #_last_yr_fullbias_adj_in_MPD
#_Cond 2031.1 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS3 sets bias_adj to 0.0 for fcast yrs)
#_Cond 0.3117 #_max_bias_adj_in_MPD (typical ~0.8; -3 sets all years to 0.0; -2 sets all non-forecast yrs w/ estimated recdevs to 1.0; -1 sets biasadj=1.0 for all yrs w/ recdevs)
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
            -3             5          -0.3             0             1             0        -1          0          0          0          0          0          0          0  #  LnQ_base_SURV(3)
...
# 1   LGL LenSelex
           ...
           -20            20      0.330098           4.7          0.05             0          3          0          0          0          0        0.5          0          0  #  Size_DblN_descend_se_LGL(1)
...
# 2   TWL LenSelex
           ...
           -20            20     -0.203828          -0.5          0.05             0          3          0          0          0          0        0.5          0          0  #  Size_DblN_top_logit_TWL(2)
           -20            20       7.25147           4.8          0.05             0          3          0          0          0          0        0.5          0          0  #  Size_DblN_ascend_se_TWL(2)
           -20            20      0.303464           4.4          0.05             0          3          0          0          0          0        0.5          0          0  #  Size_DblN_descend_se_TWL(2)
...
# 3   SURV LenSelex
           ...
           -20            20      -1.19159          -0.5          0.05             0          3          0          0          0          0        0.5          0          0  #  Size_DblN_top_logit_SURV(3)
           -20            20        6.3798           4.8          0.05             0          3          0          0          0          0        0.5          0          0  #  Size_DblN_ascend_se_SURV(3)
           -20            20      0.131958           4.4          0.05             0          3          0          0          0          0        0.5          0          0  #  Size_DblN_descend_se_SURV(3)
