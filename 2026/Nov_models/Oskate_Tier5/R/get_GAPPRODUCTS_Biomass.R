...
outpath <- here::here(AYR, 'Nov_models', 'Oskate_Tier5', 'data')
dir.create(outpath)
...
GAP_biomass <- sqlQuery(channel_akfin, query = ("
                ...
                and survey_definition_id in (52, 78, 98) 
...
write_csv(GAP_biomass, here::here(outpath, paste0('Oskate_GAPbiomass_', SYR, '.csv'))) 
